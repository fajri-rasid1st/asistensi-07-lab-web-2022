            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  ...
                  <h4 class="mt-1 mb-5 pb-1" style="font-family: Forte">WELCOME</h4>
                </div>
                ...
                <form action="" method="post">
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <a href="http://localhost/tugas 7/register.php/" type="button" class="btn btn-outline-light gradient-custom-2">Create new</a>
                  </div>
