    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <input type="submit" name="simpan" value="Simpan Data" class="btn add" data-id="nim" style="color : white; background : #a77676;" />
            </div>
        </div>
    </div>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td scope="row">
                        ...
                        <a href="/category/edit/{{$row->id}}"><button type="button" class="btn" style="color : black; background : #a3a39f; margin-bottom:5px ">Edit</button></a>
                        <a href="/category/delete/{{$row->id}}"><button type="button" class="btn" style="color : black; background : #a3a39f; margin-bottom:5px">Delete</button></a>
