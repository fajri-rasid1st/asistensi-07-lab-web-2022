      ...
      <tbody>
        ...
        <tr>
          ...
          <td scope="row">
            ...
            <a href="/sellerPermission/edit/{{$row->id}}"><button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop-{{$row->id}}" style="color : white; background : #a3a39f; margin-bottom:5px ">Edit</button></a>
            <a href="/sellerPermission/delete/{{$row->id}}"><button type="button" class="btn" style="color : white; background :  #a3a39f; margin-bottom:5px">Delete</button></a>
          </td>
        </tr>
