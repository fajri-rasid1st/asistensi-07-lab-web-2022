...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Create New Food</h1>
</div>

<div class="col lg-8">
    <form method="post" action="/dashboard/foods" class="mb-3" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input id="description" type="hidden" name="description" value="{{ old('description') }}">
            <textarea name="description" id="summernote" class="from-control"></textarea>
        </div>
        <button type="submit" class="btn btn-primary btn-sm">Create</button>
        <a href="/dashboard/foods" class="btn btn-secondary btn-sm">Kembali</a>
      </form>
...
<script>
    ...
    title.addEventListener('change', function() {
        fetch('/dashboard/foods/checkSlug?title=' + name.value)
