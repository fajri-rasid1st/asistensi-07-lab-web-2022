...
class sellerPermissionController extends Controller
{
    ...
    public function saveS_PermissionUseEloquent(Request $request){
        ...
        return redirect()->to('seller-permission')->send()->with('success', 'Data berhasil di tambahkan!');
    }
    ...
    public function editS_PermissionUseEloquent(Request $request, $id){
        ...
        return redirect()->to('seller-permission')->send()->with('success', 'Data berhasil di edit!');
    }
    ...
    public function deleteS_PermissionUseEloquent($id){
        ...
        return redirect()->to('seller-permission')->send()->with('success', 'Data berhasil di hapus!');
    }
